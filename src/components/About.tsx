  ...
  return (
    <>
      ...
      <article className="flex gap-14 items-center">
        ...
        <div>
          <h4 className="text-center mb-6 font-semibold text-3xl pb-2 relative w-fit before:content-[''] before:h-1 before:w-14 before:bg-secon before:absolute before:bottom-0 before:left-0 before:rounded mx-auto">
            {selectedSection?.title}
          </h4>
          <p className="text-lg text-center">{selectedSection?.desc}</p>
        </div>
        <img
